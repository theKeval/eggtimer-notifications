    ...
    private fun startTimer(timerLengthSelection: Int) {
        _alarmOn.value?.let {
            if (!it) {
                ...
                // TODO_done: Step 1.5 get an instance of NotificationManager and call sendNotification
                // previously used to just test the notification code. then moved to AlarmReceiver.
